...
public class NivelController implements Initializable {
        ...
        progressTimeline.setOnFinished(event -> {
            ...
            if (loss == 0) {
                ...
                if (!(levelin > App.levelOn)) {
                    CRUDFirebase.modificarDato(App.db, App.player.getEmail(), "level", App.levelOn);
                } else {
    ...
    public void Next() throws IOException {
        ...
        if (levelin > App.levelOn) {
            App.levelOn = App.levelOn + 1;
            NivelesController.letrasRango = Arrays.copyOfRange(letras, App.levelOn - 1, App.levelOn + 2);
